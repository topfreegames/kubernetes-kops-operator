...
import (
	...
	karpenter_beta "github.com/aws/karpenter-core/pkg/apis/v1beta1"
...
type KopsMachinePoolSpec struct {
	...
	// KarpenterNodePool is the list of nodePool to be applied.
	// +optional
	KarpenterNodePools []karpenter_beta.NodePool `json:"karpenterNodePools,omitempty"`
