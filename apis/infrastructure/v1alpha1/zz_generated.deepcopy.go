...
func (in *KarpenterNodePoolsV1) DeepCopyInto(out *KarpenterNodePoolsV1) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KarpenterNodePoolsV1.
func (in *KarpenterNodePoolsV1) DeepCopy() *KarpenterNodePoolsV1 {
	if in == nil {
		return nil
	}
	out := new(KarpenterNodePoolsV1)
	in.DeepCopyInto(out)
	return out
}
...
func (in *KopsMachinePoolSpec) DeepCopyInto(out *KopsMachinePoolSpec) {
	*out = *in
	...
	if in.KarpenterNodePoolsV1 != nil {
		...
		*out = make([]KarpenterNodePoolsV1, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
